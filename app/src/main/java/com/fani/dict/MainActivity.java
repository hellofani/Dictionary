...
public class MainActivity extends AppCompatActivity {
    ...
    private void initViews(){
        ...
        v.setLayoutParams(new CoordinatorLayout.LayoutParams(CoordinatorLayout.LayoutParams.MATCH_PARENT, CoordinatorLayout.LayoutParams.MATCH_PARENT));
       ...
       floatingActionsMenu = (FloatingActionsMenu) findViewById(R.id.multiple_actions_down);
        ...
        //zoomView.addView(mRecyclerView);
